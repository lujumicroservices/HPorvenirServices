            ...
            */
            ...
            using (Tiff output = Tiff.ClientOpen(outfilename, "w", t2p, t2p.m_stream))
            {
                ...
                */
                ...
                //using (FileStream file = new FileStream("c:\\dev\\file.pdf", FileMode.Create, System.IO.FileAccess.Write))
                //{
                //    byte[] bytes = new byte[t2p.m_outputfile.Length];
                //    t2p.m_outputfile.Read(bytes, 0, (int)t2p.m_outputfile.Length);
                //    file.Write(bytes, 0, bytes.Length);
                //    t2p.m_outputfile.Close();
                //}
            }

            return t2p.m_outputfile;
